...
{{ config(
  ...
  cluster_by=['customer_country','taxonomy_business_category_group','months_since_cohort'],
  persist_docs={'relation': true, 'columns': true},
  on_schema_change='sync_all_columns',
  tags=['marts','cohort','retention','monthly']
) }}
...
with base as (
  ...
  from {{ ref('fct_customer_active_monthly') }} m

    ...
    create or replace table `manuel-demo-1392926998`.`analytics`.`fct_customer_active_monthly`
    ...
    OPTIONS(
      description="""Monthly rollup of subscription-level activity at grain (customer_id, month_start).\n"""
    )
    as (
      -- ========================================================================================

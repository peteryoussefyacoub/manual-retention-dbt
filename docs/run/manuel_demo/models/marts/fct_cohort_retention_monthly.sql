    ...
    create or replace table `manuel-demo-1392926998`.`analytics`.`fct_cohort_retention_monthly`
      
    partition by cohort_month
    cluster by customer_country, taxonomy_business_category_group, months_since_cohort

    
    OPTIONS(
      description="""Monthly retention counts by cohort and slices using the monthly rollup. A customer is retained in a given month if any subscription is active that month.\n"""
    )
    as (
      -- ========================================================================================

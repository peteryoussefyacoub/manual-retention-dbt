    ...
    create or replace table `manuel-demo-1392926998`.`analytics`.`fct_cohort_retention_daily`
      
    partition by cohort_date
    cluster by customer_country, taxonomy_business_category_group, days_since_cohort

    
    OPTIONS(
      description="""Daily retention counts by cohort and slices with per-slice cohort sizes."""
    )
    as (
      -- ========================================================================================

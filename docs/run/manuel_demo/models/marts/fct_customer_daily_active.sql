    ...
    create or replace table `manuel-demo-1392926998`.`analytics`.`fct_customer_daily_active`
      
    partition by activity_date
    cluster by customer_id, subscription_number, customer_country, taxonomy_business_category_group

    
    OPTIONS(
      description="""Subscription-level daily activity at grain (customer_id, subscription_number,  activity_date).\n"""
    )
    as (
      -- ========================================================================================

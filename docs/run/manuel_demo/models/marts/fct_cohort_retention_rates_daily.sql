  ...
  create or replace view `manuel-demo-1392926998`.`analytics`.`fct_cohort_retention_rates_daily`
  OPTIONS(
      description="""Daily retention counts joined with cohort sizes to compute retention_rate (0..1) for each cohort_date and days_since_cohort across slice dimensions.\n"""
    )
  as -- ========================================================================================

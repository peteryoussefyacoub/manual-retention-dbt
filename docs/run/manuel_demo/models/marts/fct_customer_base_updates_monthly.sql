    ...
    create or replace table `manuel-demo-1392926998`.`analytics`.`fct_customer_base_updates_monthly`
    ...
    OPTIONS(
      description="""Monthly customer movements: new_customers (cohort starts), retained_customers (active but not new), churned_customers (last activity month).\n"""
    )
    as (
      -- ========================================================================================
